...
//	public static void extractGuessPronounFea(EntityMention pronoun, CoNLLSentence s,
//			CoNLLPart part) {
//		try {
...
//	}
	...
	public static ArrayList<ResolveGroup> extractGroups(CoNLLPart part) {
		...
		for (int i = 0; i < part.getCoNLLSentences().size(); i++) {
			...
			s.mentions = EMUtil.extractEntityMention(s);
...
//			EntityMention ant, EntityMention m, Context context, boolean sameSpeaker,

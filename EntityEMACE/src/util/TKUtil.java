...
public class TKUtil {
	...
	public static String getMinExpansion(EntityMention ant, EntityMention zero,
...
//		}
	...
	public static String getSimpleExpansion(EntityMention ant, EntityMention zero,
			CoNLLPart part, boolean isZP, String pro) {
		MyTreeNode zTreeRoot = part.getWord(zero.start).sentence
				.getSyntaxTree().root.copy();
		if (isZP) {
...
//		}
	...
	public static String getFullExpansion(EntityMention ant, EntityMention zero,
			CoNLLPart part, boolean isZP, String pro) {
		MyTreeNode zTreeRoot = part.getWord(zero.start).sentence
				.getSyntaxTree().root.copy();
		if (isZP) {
...
//		}
	...
	public static String getDynamicExpansion(EntityMention ant, EntityMention zero,
			CoNLLPart part, boolean isZP, String pro) {
		MyTreeNode zTreeRoot = part.getWord(zero.start).sentence
				.getSyntaxTree().root.copy();
		if (isZP) {
	...
	public static String getTree(EntityMention ant, EntityMention zero, CoNLLPart part) {
